---
ID: 3391
post_title: Frinx ODL distribution 1.4.2
author: knevolnikova@frinx.io
post_date: 2016-12-22 16:17:31
post_excerpt: ""
layout: post
permalink: >
  https://frinx.io/frinx-documents/frinx-odl-distribution-1-4-2.html
published: true
---
...
1.  <span class="line">Add ability to ignore nodes from specific namespaces in ALU customization of netconf connector.</span>
2.  <span class="line">Fix race condition in Restconf - fix detection of empty body of HTTP request.</span>
3.  <span class="line">Support of SROS 14.0R04 - new ALU customization that ignores candidate capability.</span>
4.  <span class="line">Fix writing to inventory nodes by netconf connector.</span>
